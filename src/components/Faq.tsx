    ...
    <section style={{ backgroundColor: 'var(--color-light)', borderTop: '1px solid var(--color-light-border)' }}>
      <div className="max-w-7xl mx-auto px-6 py-24 md:py-32">
        ...
        <div ref={ref} className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          ...
          >
            <p className="text-[14px] leading-relaxed max-w-xs md:text-right" style={{ color: 'var(--color-light-secondary)' }}>
              Başlamadan önce aklınıza takılan sorulara yanıt bulun.
            </p>
            <Link
              to="/iletisim"
              className="text-[12px] font-semibold hover:opacity-60 transition-opacity"
        ...
        <div className="flex flex-col lg:flex-row gap-16">
              ...
              >
                ...
                <AnimatePresence>
                  {openIndex === i && (
                    ...
                    >
                      <div
                        className="pl-10 pr-12 py-5 text-[14px] leading-[1.85]"
          ...
          >
            ...
            >
              ...
              <p className="text-[13px] leading-relaxed mb-7" style={{ color: 'var(--color-light-secondary)' }}>
                Projeniz hakkında konuşmak veya teklife ihtiyaç duymak için bize yazın.
              </p>
              <Link
                to="/iletisim"
                className="inline-flex items-center justify-center w-full h-10 text-[12px] font-semibold hover:opacity-85 transition-opacity"
            ...
            <div className="mt-6 space-y-5">
              {[
                ...
                <div key={item.label} className="flex items-center justify-between py-3.5 border-b" style={{ borderColor: 'var(--color-light-border)' }}>
                  <span className="text-[12px]" style={{ color: 'var(--color-light-secondary)' }}>{item.label}</span>
                  <span className="text-[12px] font-semibold" style={{ color: 'var(--color-light-text)' }}>{item.value}</span>
                </div>
              ))}
            </div>
          </motion.div>
