      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[17px] sm:text-[13px] leading-relaxed mb-6 max-w-[220px]" style={{ color: 'var(--color-secondary)' }}>
                  ...
                  <li key={link.label}>
                    {isAnchor ? (
                      <a
                        ...
                        className="text-[17px] sm:text-[13px] transition-colors duration-200 hover:text-primary"
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-start gap-2.5 text-[17px] sm:text-[13px] transition-colors duration-200 hover:text-primary"
                style={{ color: 'var(--color-secondary)' }}
              >
              ...
              <p className="flex items-start gap-2.5 text-[17px] sm:text-[13px]" style={{ color: 'var(--color-secondary)' }}>
