      ...
      <div className="max-w-7xl mx-auto px-6 py-24 md:py-32">
        ...
        <div ref={ref} className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          ...
          >
            <Link
              to="/urunler"
              className="group flex items-center gap-2 text-[13px] font-medium hover:opacity-60 transition-opacity"
        ...
        {teaserProducts.length === 0 && (
          ...
          >
            <p className="text-[13px] mb-4" style={{ color: 'var(--color-light-secondary)' }}>
